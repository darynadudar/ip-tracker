...
![Design preview for the IP address tracker coding challenge](../../Downloads/ip-address-tracker-master/design/desktop-preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](../../Downloads/ip-address-tracker-master/README-template.md) file in this starter code.
